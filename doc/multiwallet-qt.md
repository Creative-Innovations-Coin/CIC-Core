...
Only requiring some minor changes is cic.cpp.
...
Changes to cic.cpp
----------------------
cic.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
