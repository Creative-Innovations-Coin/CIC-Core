...
This mechanism has been integrated into Bitcore-Node-Cic which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ciccoin/insight-api-cic#web-socket-api](https://github.com/ciccoin/insight-api-cic#web-socket-api) 
* API: [https://github.com/ciccoin/insight-api-cic#instantsend-transactions](https://github.com/ciccoin/insight-api-cic#instantsend-transactions) 
...
By default, the Cic Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Cic Core daemon:
