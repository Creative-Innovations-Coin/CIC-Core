    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Cic Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Cic Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  cic-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Cic in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PrivateSend uses an cictive process to mix your inputs with the inputs of two other people, without having your coins ever leave your wallet. \
...
These denominations are 0.01 CIC, 0.1 CIC, 1 CIC and 10 CIC -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://ciccoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://ciccoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Cic Core is shutting down...") + "<br /><br />" +
