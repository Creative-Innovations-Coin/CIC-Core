    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Cic Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Cic address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cic: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Cic Core"), this);
    aboutAction->setStatusTip(tr("Show information about Cic Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Cic Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Cic addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Cic addresses"));
    ...
    openAction->setStatusTip(tr("Open a cic: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Cic Core help message to get a list with possible Cic Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Cic Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Cic network", "", count));
}
...
{
    QString strTitle = tr("Cic Core"); // default title
